...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/justteen/musicalbuzz",
)
...
# You'll need a Pyrogram String Session for these vars. Generate String from our session generator bot @BuzzStringBot
