...
import config
from BuzzMusic import Carbon, YouTube, app
from BuzzMusic.core.call import Buzz
from BuzzMusic.misc import db
from BuzzMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from BuzzMusic.utils.exceptions import AssistantErr
from BuzzMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from BuzzMusic.utils.inline.playlist import close_markup
from BuzzMusic.utils.pastebin import Buzzbin
from BuzzMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Buzz.force_stop_stream(chat_id)
