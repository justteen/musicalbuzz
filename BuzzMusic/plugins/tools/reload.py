...
from BuzzMusic import app
from BuzzMusic.core.call import Buzz
from BuzzMusic.misc import db
from BuzzMusic.utils.database import get_authuser_names, get_cmode
from BuzzMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from BuzzMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Buzz.stop_stream(message.chat.id)
    except:
        pass
